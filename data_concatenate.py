...
for idx in range(0,4):
    file_name = 'u_data_' + 'idx-' + str(idx) + '_test4.pt'
...
torch.save(concatenated_u_tensor, os.path.join(FOLDER_PATH , f'u_data_' + 'cat' + '_test4.pt'))

# x data cat
for idx in range(0,4):
    file_name = 'x_data_' + 'idx-' + str(idx) + '_test4.pt'
    file_path = os.path.join(FOLDER_PATH , file_name)
    tensor = torch.load(file_path)
...
torch.save(concatenated_x_tensor, os.path.join(FOLDER_PATH , f'x_data_' + 'cat' + '_test4.pt'))

# j data cat
for idx in range(0,4):
    file_name = 'j_data_' + 'idx-' + str(idx) + '_test4.pt'
    file_path = os.path.join(FOLDER_PATH , file_name)
    tensor = torch.load(file_path)
...
torch.save(concatenated_j_tensor, os.path.join(FOLDER_PATH , f'j_data_' + 'cat' + '_test4.pt'))